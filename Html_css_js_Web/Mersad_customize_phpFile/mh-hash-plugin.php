...
/*
Plugin Name: MH Hashed Link
Description: جایگزین دکمه «افزودن به سبد» با لینک هش شده شما

نحوه استفاده (خیلی ساده و دوستانه):

1. پوشه پلاگین رو توی wp-content/plugins آپلود کن.
2. از پیشخوان وردپرس، افزونه MH Hashed Link رو فعال کن.
3. تو صفحه ویرایش هر محصول، از ستون کناری لینک هش‌شده‌ت رو وارد کن و ذخیره کن.
4. تمام! حالا دکمه خرید/دانلود خودکار با همون لینک نمایش داده میشه :)
*/
