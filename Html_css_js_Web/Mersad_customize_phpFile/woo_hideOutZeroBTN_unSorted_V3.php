...
// 2. استایل برای مخفی کردن دکمه‌های افزودن به سبد خرید
add_action('wp_head', function() {
    ?>
    <style>
        /* صفحه محصول تکی */
        ...
        /* دکمه افزودن به سبد خرید در آرشیو محصولات (لیست/شبکه) */
        ...
        /* دکمه در بلاک‌های ووکامرس (مانند تازه‌ترین محصولات) */
...
// استایل برای مخفی کردن دکمه افزودن به سبد خرید محصولات رایگان
add_action('wp_head', function() {
    ?>
    <style>
        /* صفحه محصول تکی */
        ...
        /* دکمه افزودن به سبد خرید در آرشیو و فروشگاه */
        .mh-free-product .add_to_cart_button,
        .mh-free-product .ajax_add_to_cart,
        .mh-free-product .single_add_to_cart_button {
            display: none !important;
        ...
        /* بلاک‌های گوتنبرگ (جدیدترین، پرفروش‌ترین و …) */
        .mh-free-product .wc-block-grid__product-add-to-cart {
            display: none !important;
        }

        /* حتی کل دکمه داخل بلاک */
